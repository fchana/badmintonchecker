...
firebase.initializeApp(firebaseConfig);
  firebase.analytics();
      ...
      var count = dataref.ref("/courtall")
      count.on("value", function(snap){
      var count = snap.val()
      var count1 = count.court1
      console.log(count)
      if(count1 == "1"){
          document.getElementById("lightStatus").innerText = "Cort1 is full"
      }else{
          document.getElementById("lightStatus").innerText = "Cort1 is empty"
      }
      
      var count2 = count.court2
      if(count2 == "1"){
          document.getElementById("lightStatus2").innerText = "Cort2 is full"
      }else{
          document.getElementById("lightStatus2").innerText = "Cort2 is empty"
      }
      console.log(count2)
      var count3 = count.court3
      if(count3 == "1"){
          document.getElementById("lightStatus3").innerText = "Cort3 is full"
      }else{
          document.getElementById("lightStatus3").innerText = "Cort3 is empty"
      }
  });
